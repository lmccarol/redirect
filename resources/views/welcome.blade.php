...
background-size: cover;">
    ...
    <div class="flex h-screen justify-center items-center">
        <div class="text-center" style="background-color:rgba(0, 0, 0, 0.8)">
            ...
            <h1 class="text-4xl " style="color: #e20e2b;">{{ __('index.Titlemsg') }}</h1>
            <p class="text-xl text-white px-12">{{ __('index.msgbox') }}</p>

            <a href="https://portal.netsolid.ca"
                class="inline-block text-xl px-4 py-2 border rounded text-white font-bold hover:border-transparent hover:text-blue-500 hover:bg-white  mt-6 mb-6">{{ __('index.portal') }}</a>
